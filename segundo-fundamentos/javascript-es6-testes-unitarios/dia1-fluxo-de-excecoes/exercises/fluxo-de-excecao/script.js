//Criação da Array de Objetos com os produdos e preços
const promo = [
...
//Adicionando o escutador de evento no botão para mostrar a promoção
...
//Concatena a mensagem; se algo der errado captura a mensagem de erro
...
//Verifica se o número caracteres válidos, se nao possui ele joga o erro
...
//Retorna a promoção com base no número inserido no input de número da página
